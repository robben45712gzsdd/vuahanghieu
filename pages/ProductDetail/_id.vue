          ...
          <ul class="nav">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end">
                <li>
                  <a class="text-uppercase dropdown-item" href="/login">Đăng nhập</a>
                </li>
                <li>
                  <a class="text-uppercase dropdown-item" href="/signup">Đăng ký</a>
                </li>
              </ul>
            </li>
            <li class="nav-item">
      ...
      <div class="py-5 container">
        <div class="d-flex align-items-center justify-content-between row">
          ...
          <div class="mb-2 mb-md-0 col-md-6 col-12">
            <a-dropdown :visible="showDropdown" :trigger="[]" placement="bottomLeft">
              <div class="input-group">
                <input type="text" class="form-control header-search" placeholder="Tìm kiếm sản phẩm, thương hiệu..."
                  @focus="showDropdown = true" @blur="showDropdown = false" v-model="searchQuery" />
              ...
              <!-- Dropdown menu -->
              <div slot="overlay" class="search-custom-w bg-white shadow-lg border rounded search-dropdown-content p-4"
                @mousedown.prevent>
                <!-- Có thể bạn quan tâm -->
                <div class="mb-4">
                  <h6 class="fw-bold mb-3">CÓ THỂ BẠN QUAN TÂM</h6>
                  <nuxt-link v-for="(item, index) in trendingLinks" :key="index" :to="item.url"
                    class="d-flex flex-row align-items-center text-decoration-none text-dark mb-2">
                    <div class="icon-trending me-2">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-graph-up-arrow text-danger" viewBox="0 0 16 16">
                ...
                <div class="mb-4">
                  ...
                  <div class="row g-2">
                    <div v-for="cat in categoriesSearch" :key="cat.name" class="col-4 col-md-2">
                      <nuxt-link :to="cat.link" class="d-block text-decoration-none text-center p-2 bg-light rounded">
                ...
                <div>
                  ...
                  <div class="row g-2">
                    <div v-for="(brand, idx) in brandsSearch" :key="idx" class="col-4 col-md-2">
                      <nuxt-link :to="brand.link" class="d-block text-decoration-none text-center p-2 bg-light rounded">
                        <div style="
                              height: 50px;
                              display: flex;
                              align-items: center;
      ...
      <div class="row">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><nuxt-link to="/dior">Dior</nuxt-link></li>
            <li class="breadcrumb-item"><nuxt-link to="/dior/son-moi">Son Môi Dior</nuxt-link></li>
            <li class="breadcrumb-item active" aria-current="page">Son Dior Addict Lip Maximizer 024 Intense Brick Màu
              Đỏ Đất</li>
          </ol>
        </nav>
        ...
        <div class="row">
          ...
          <div class="col-lg-5">
            ...
            <div class="d-flex flex-wrap mt-2">
              <a v-for="(image, index) in productImages" :key="index" href="#" @click.prevent="setActiveSlide(index)"
          ...
          <div class="col-lg-7">
            <h2 class="fw-bold mb-2">
              <nuxt-link to="/dior" class="text-decoration-none text-dark">Dior</nuxt-link>
            </h2>
            ...
            <div class="mb-3">
              <p class="mb-1">Mã SP: <span class="fw-semibold">h064757</span></p>
              <p class="mb-1">Danh mục: <nuxt-link to="/son-moi" class="text-decoration-none text-primary">Son
                  Môi</nuxt-link></p>
              <p class="mb-1">Lượt mua: <span class="fw-semibold text-dark">660</span></p>
              <p class="text-muted small">
                Lượt mua này được tổng hợp từ lượt bán thành công của các sản phẩm tương tự trên Vua Hàng Hiệu.
              </p>
            </div>
            ...
            <div class="mb-3 d-flex align-items-center">
              ...
              <div class="text-warning me-2">
                ...
                <i class="bi bi-star-fill"></i>
                <i class="bi bi-star-fill"></i> -->
                <img src="@/assets/images/productThumnail/star-list.svg" alt="star" width="100" />
              </div>
              <a href="#" class="text-decoration-none text-primary small">Viết đánh giá</a>
            </div>
            ...
            <div class="d-flex">
              ...
              <div class="w-50 pe-3">
                <!-- Giá -->
                <div class="mb-3">
                  <h3 class="text-danger fw-bold fs-3 mb-1">849.000 đ</h3>
                  <p class="text-muted mb-0">
                    <s>1.300.000 đ</s>
                    <span class="badge bg-danger ms-2">Giảm 35%</span>
                  </p>
                </div>

                <!-- Thông tin sản phẩm -->
                <div class="mb-3">
                  <p class="mb-1"><strong>Giới tính:</strong> Nữ</p>
                  <p class="mb-1"><strong>Màu sắc:</strong> Đỏ đất</p>
                  <p class="mb-1"><strong>Xuất xứ thương hiệu:</strong> Pháp</p>
                  <p class="mb-1"><strong>Phân loại:</strong> Son kem</p>
                  <p class="mb-1">
                    <strong>Gọi đặt mua:</strong>
                    <a href="tel:0939348888" class="text-decoration-none text-danger fw-semibold">093.934.8888</a>
                ...
                <div class="d-flex flex-wrap gap-2 mb-3">
                  <button class="btn btn-dark fw-semibold text-uppercase">Thêm vào giỏ</button>
                  <button class="btn btn-danger fw-semibold text-uppercase">Mua ngay</button>
                </div>

                <!-- Chia sẻ -->
                <div>
                  <strong>Chia sẻ:</strong>
                  <ul class="list-inline d-inline-flex align-items-center ms-2 mb-0">
                    ...
                    <li class="list-inline-item">
                      <div class="d-inline-block" style="width: 20px;">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                          ...
                          style="enable-background:new 0 0 155.139 155.139;" xml:space="preserve" class="mdl-js">
                          <g>
                    ...
                    <li class="list-inline-item">
                      <div class="d-inline-block" style="width: 20px;">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                          id="Capa_1" x="0px" y="0px" viewBox="0 0 438.529 438.529"
                          style="enable-background:new 0 0 438.529 438.529;" xml:space="preserve" class="mdl-js">
                          <g>
                            <path
                  ...
                  <button class="btn btn-link text-decoration-none text-dark p-0 ms-3">
              ...
              <div class="w-50 ps-3">
                <div class="border rounded p-2 bg-white">
                  ...
                  <a href="/app" class="d-block mb-2">
                    <img src="@/assets/images/productThumnail/banner-app-dk.png" alt="VHH App"
                  ...
                  <div class="border rounded p-3 mb-3">
                    <div class="d-flex align-items-start mb-2">
                      <div class="me-2">
                        <img src="@/assets/images/productThumnail/shop.svg" width="20" height="20" alt="shop">
                      </div>
                      <div class="flex-grow-1">
                        <div class="d-flex justify-content-between align-items-center">
                          <a href="/shop/the-signature-hub" class="fw-bold text-dark text-decoration-none">The Signature
                            Hub</a>
                          <button class="btn btn-sm btn-outline-warning py-0 px-2">Theo dõi</button>
                        </div>
                    ...
                    <ul class="list-unstyled mb-3 small">
                      <li class="d-flex align-items-start mb-1">
                        <img src="@/assets/images/productThumnail/checkbox.svg" width="16" height="16" alt="check"
                          class="me-2 mt-1">
                        <span>Miễn phí đổi trả <a href="/tin-tuc/chinh-sach-doi-tra" target="_blank"
                            class="text-primary">(Xem điều kiện đổi trả)</a></span>
                      </li>
                      <li class="d-flex align-items-start mb-1">
                        <img src="@/assets/images/productThumnail/checkbox.svg" width="16" height="16" alt="check"
                          class="me-2 mt-1">
                    ...
                    <div class="text-center mb-2">
                      <a href="/shop/the-signature-hub" class="btn btn-outline-dark w-100">XEM SHOP</a>
                    </div>
                    <div class="text-center small">
                      Bán hàng cùng Vua Hàng Hiệu?
                      <a href="http://seller.vuahanghieu.com/register" target="_blank" class="text-primary">Đăng ký</a>
                    </div>
                  </div>
                  ...
                  <div class="d-flex align-items-start small text-muted">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ff0000"
                      class="bi bi-exclamation-triangle mdl-js" viewBox="0 0 16 16">
                      <path
                        d="M7.938 2.016A.13.13 0 0 1 8.002 2a.13.13 0 0 1 .063.016.146.146 0 0 1 .054.057l6.857 11.667c.036.06.035.124.002.183a.163.163 0 0 1-.054.06.116.116 0 0 1-.066.017H1.146a.115.115 0 0 1-.066-.017.163.163 0 0 1-.054-.06.176.176 0 0 1 .002-.183L7.884 2.073a.147.147 0 0 1 .054-.057zm1.044-.45a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.713c.889 0 1.438-.99.98-1.767L8.982 1.566z" />
                      <path
                        d="M7.002 12a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 5.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 5.995z" />
                    </svg>
                    <span>Nếu bạn không thêm được sản phẩm vào giỏ hàng? Hãy <span class="text-danger fw-semibold">báo
                        lỗi</span> cho chúng tôi.</span>
                  </div>
                </div>
        ...
        <div class="mt-5 border-top pt-3">
          <h5 class="fw-bold mb-3">
            ...
            <span class="text-danger fw-normal small">
              (Giảm 20.000 đ với mỗi sản phẩm mua kèm)
            </span>
          </h5>
          ...
          <div class="row">
            ...
            <div class="col-lg-8">
              <div class="d-flex align-items-center mb-3">
                <img src="@/assets/images/productThumnail/product1.webp" alt="sp1" class="img-fluid me-2"
                  style="width: 100px; height: 100px; object-fit: contain;" />
                <span class="fs-4 fw-bold text-secondary">+</span>
                <img src="@/assets/images/productThumnail/product1.webp" alt="sp2" class="img-fluid ms-2"
                  style="width: 100px; height: 100px; object-fit: contain;" />
              </div>

              <div class="form-check mb-1">
                <input class="form-check-input" type="checkbox" id="sp1" checked />
                <label class="form-check-label" for="sp1">
                  Son Dior Addict Lip Maximizer 024 Intense Brick Màu Đỏ Đất
                  <span class="text-danger">849.000 đ</span>
                </label>
              </div>

              <div class="form-check mb-3">
                <input class="form-check-input" type="checkbox" id="sp2" checked />
                <label class="form-check-label" for="sp2">
                  Son Dưỡng Dior Addict Lip Maximizer 018 Intense Spice Màu Hồng Đất
                  <span class="text-danger">935.000 đ</span>
                </label>
              </div>

              <div class="d-flex align-items-center mb-3">
                <span class="fw-bold me-2">Tổng tiền:</span>
                <span class="fw-bold fs-5 text-danger">1.784.000 đ</span>
              </div>

              <button class="btn btn-outline-dark fw-semibold px-4">
            ...
            <div class="py-4 container suggested-products">
              <h5 class="mb-3 pb-2 border-3 border-black border-bottom text-center fw-normal"
                style="width: max-content;">
                Có thể bạn cũng thích
              </h5>
              <div class="position-relative product-carousel">
                <VueSlickCarousel v-bind="productCarouselSettings" ref="productSlick">
                  <div v-for="(product, index) in productsSuggest" :key="index" class="px-2">
                    <nuxt-link :to="product.url" class="position-relative border-0 h-100 card product-card">
                      <!-- Huy hiệu giảm giá -->
                      <div class="top-0 position-absolute bg-danger m-2 px-2 py-1 text-white end-0 fs-8"
            ...
            <!-- Cột lựa chọn khác -->
            <div class="col-lg-4">
              <h6 class="fw-bold mb-3">Lựa chọn khác:</h6>
              <div class="row g-2">
                <div class="col-4 text-center" v-for="(item, index) in otherProducts" :key="index">
                  <img :src="item.image" alt="option" class="img-fluid border rounded mb-1"
                    style="width: 100%; height: 90px; object-fit: contain;" />
                  <p class="text-danger fw-semibold small mb-0">{{ item.price }}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="d-flex gap-5">
          <div class="mt-5 col-md-8">
            <ul class="nav nav-tabs">
              <li class="nav-item">
                <a class="nav-link" :class="{ active: activeTab === 'details' }" @click="activeTab = 'details'">Chi
                  tiết</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" :class="{ active: activeTab === 'reviews' }" @click="activeTab = 'reviews'">Bình
                  luận
                  <span class="badge bg-secondary">106</span></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" :class="{ active: activeTab === 'qa' }" @click="activeTab = 'qa'">Hỏi đáp</a>
              </li>
            </ul>
            <div class="tab-content p-4 border">
              <div v-if="activeTab === 'details'" class="tab-pane active">
                <div class="container py-4">
                  <div class="product-bottom-col">
                    <div class="tab-container">
                      <div class="content-product">
                        <p>
                          <strong>
                            <a href="https://vuahanghieu.com/dior/son-moi" title="Son Dior">Son Dior</a>
                            Addict Lip Maximizer 024 Intense Brick Màu Đỏ Đất
                          </strong>
                          là một sản phẩm nổi bật trong bộ sưu tập son dưỡng của thương hiệu Dior...
                        </p>

                        <h2 class="h4 mt-4">Giới thiệu dòng son Dior Addict Lip Maximizer 024</h2>
                        <p>
                          <a href="https://vuahanghieu.com/dior/son-moi" title="son môi Dior">Son môi Dior</a>
                          Addict Lip Maximizer 024 là một trong những sản phẩm đình đám...
                        </p>

                        <div class="text-center my-4">
                          <img src="@/assets/images/productThumnail/maxresdefault-1-jpg-1726029810-11092024114330.webp"
                            alt="Son Dior Addict Lip Maximizer 024 Intense Brick" class="img-fluid rounded" />
                          <em class="d-block mt-2">Dior Addict Lip Maximizer 024 Intense Brick</em>
                        </div>

                        <p>
                          Son môi Dior Addict Lip Maximizer ra mắt lần đầu vào năm 2007...
                        </p>

                        <h2 class="h4 mt-4">Màu sắc và đặc trưng của Son Dior Addict Lip Maximizer 024</h2>
                        <p>
                          Son Dior Addict Lip Maximizer 024 có tông màu đỏ đất trầm ấm...
                        </p>

                        <div class="text-center my-4">
                          <img
                            src="@/assets/images/productThumnail/son-duong-dior-addict-lip-maximizer-024-intense-brick-35-1-jpg-1726029181-11092024113301.webp"
                            alt="Son Dior Addict Lip Maximizer" class="img-fluid rounded" />
                        </div>

                        <h2 class="h4 mt-4">Thiết kế son Dior Addict Lip Maximizer 024 Intense Brick</h2>
                        <p>
                          Thiết kế của Dior Addict Lip Maximizer 024 mang vẻ đẹp tinh tế...
                        </p>

                        <div class="text-center my-4">
                          <img
                            src="@/assets/images/productThumnail/024-min_268c3a5807784641875a3278b5219688_1024x1024-1-jpg-1726029102-11092024113142.webp"
                            alt="Thiết kế son Dior Addict Lip Maximizer" class="img-fluid rounded" />
                        </div>

                        <h2 class="h4 mt-4">Bảng thông tin sản phẩm</h2>
                        <table class="table table-bordered table-striped">
                          <tbody>
                            <tr>
                              <td><strong>Thương hiệu</strong></td>
                              <td><a href="https://vuahanghieu.com/dior">DIOR</a></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td><strong>Khả năng bám màu</strong></td>
                              <td>6 - 8h</td>
                            </tr>
                          </tbody>
                        </table>
                        ...
                        <p>
                          Bạn có thể mua chính hãng tại
                          <a href="https://vuahanghieu.com">Vua Hàng Hiệu</a>.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="d-flex align-items-center mb-3 w-100">
                  <div class="p-4 bg-light rounded border w-100">
                    <div class="row">
                      ...
                      <div class="col-md-5">
                        <div class="d-flex align-items-center mb-1" v-for="i in 5" :key="i">
                          <span class="me-2 text-warning"><i class="bi bi-star-fill"></i> {{ 6 - i }}</span>
                          <div class="progress flex-grow-1" style="height: 6px;">
                            <div class="progress-bar bg-dark" :style="{ width: getPercent(6 - i) + '%' }"></div>
                          </div>
                          <span class="ms-2 text-muted small">({{ getCount(6 - i) }})</span>
                        </div>
                      </div>

                      <!-- Cột phải: nút -->
                      <div class="col-md-3 text-center d-flex flex-column justify-content-center">
                        <span class="small text-muted mb-2">Chia sẻ nhận xét về sản phẩm</span>
                        <button class="btn btn-dark px-4 text-uppercase fw-semibold">Viết nhận xét</button>
                      </div>
                    </div>
                    ...
                    <div class="review-item mb-3 d-flex">
                      ...
                      <div>
                        ...
                        <div class="text-success small"> <i class="bi bi-check-circle"></i> Đã mua hàng </div>
              ...
              <div v-if="activeTab === 'qa'" class="tab-pane active">
                <div class="card mb-3">
                  <div class="card-body">
                    ...
                    <div v-for="(item, index) in sampleQuestions" :key="index" class="mb-4">
                      ...
                      <button v-if="item.answer === 'TRẢ LỜI'" @click="saveAnswer(index)"
                        class="btn btn-primary btn-sm">Gửi</button>
        ...
        <!-- Suggested products  -->
        <div class="py-4 container suggested-products">
          <h3 class="m-auto mb-3 pb-2 border-3 border-black border-bottom text-center fw-normal"
            style="width: max-content">
        ...
        <div class="to-gift-is-to-love container">
          <img src="@/assets/images/banner/banner-to-gift.webp" alt="to gift is to love"
            class="rounded w-100 img-fluid" />
          <!-- Content for Brand Top Sale can be added here -->
          <div class="position-relative product-carousel">
            <VueSlickCarousel v-bind="productCarouselSettings" ref="productSlick">
              <div v-for="(product, index) in productsGiftToLove" :key="index" class="px-2">
                <nuxt-link :to="product.url" class="position-relative border-0 h-100 card product-card">
                  <!-- Huy hiệu giảm giá -->
                  <div class="top-0 position-absolute bg-danger m-2 px-2 py-1 text-white end-0 fs-8"
                    v-if="product.discount">
          ...
          <p class="mt-4">
            <b>Miễn trừ trách nhiệm</b>: Mặc dù chúng tôi luôn cố gắng đảm bảo rằng mọi thông tin đều chính xác, nhưng
            đôi khi
            nhà sản xuất có thể thay đổi danh sách thành phần của sản phẩm. Bao bì và thành phần trong thực tế có thể
            khác biệt với những gì được mô tả trên website. Chúng tôi khuyến cáo bạn không nên chỉ dựa trên thông tin
            được ghi trên website, mà hãy luôn luôn đọc nhãn mác, cảnh báo và hướng dẫn sử dụng trước khi dùng sản phẩm.
            Để biết thêm thông tin, vui lòng liên hệ nhà sản xuất. Nội dung trên trang web này chỉ được dùng để tham
            khảo, không thể thay thế chỉ dẫn của dược sỹ, bác sỹ và các chuyên gia sức khỏe. Bạn không nên sử dụng thông
            tin này để tự chẩn đoán và điều trị bệnh của mình. Hãy liên hệ các cơ quan y tế ngay lập tức nếu bạn nghi
            ngờ mình đang gặp vấn đề về sức khỏe. Các thông tin và công bố liên quan đến thực phẩm chức năng giảm cân
            chưa được thẩm định bởi Cục quản lý Thực phẩm và Dược phẩm, cũng như không được dùng để chẩn đoán, điều trị,
            chữa trị, hay phòng ngừa bệnh tật cùng các vấn đề sức khỏe khác. Chúng tôi không chịu trách nhiệm về nhầm
            lẫn hay sai lệch về sản phẩm.
          </p>
        </div>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      sampleQuestions: [
        ...
        {
          question: 'Hôm nay đá hàng thị trường ngay 2 ngày có nhắn dược không à?',
          answer: 'TRẢ LỜI',
      ...
      productImages: [
        {
          src: require('@/assets/images/productThumnail/product1.webp'),
          thumbnail: '',
          alt: 'Son Dior Addict Lip Maximizer 024 Intense Brick Màu Đỏ Đất-1',
        },
        {
          src: require('@/assets/images/productThumnail/product2.webp'),
          thumbnail: '',
          alt: 'Son Dior Addict Lip Maximizer 024 Intense Brick Màu Đỏ Đất-2',
        },
        {
          src: require('@/assets/images/productThumnail/product3.webp'),
          thumbnail: '',
          alt: 'Son Dior Addict Lip Maximizer 024 Intense Brick Màu Đỏ Đất-3',
        },
        {
          src: require('@/assets/images/productThumnail/product4.webp'),
          thumbnail: '',
          alt: 'Son Dior Addict Lip Maximizer 024 Intense Brick Màu Đỏ Đất-4',
        },
      ],
      // relatedProducts: [
      //   {
      //     id: 1,
      //     title: 'Son Dưỡng Dior Addict Lip Maximizer 009 Intense Rosewood Màu Hồng Đất',
      //     link: '/son-dior-addict-lip-maximizer-009-mau-hong-dat-ph064622',
      //     image: 'https://cdn.vuahanghieu.com/unsafe/0x250/left/top/smart/filters:quality(90)/https://admin.vuahanghieu.com/upload/product/2022/12/son-dior-addict-lip-maximizer-009-intense-rosewood-mau-hong-dat-moi-nhat-2022-63ae8817888b4-30122022134127.jpg',
      //     newPrice: '890.000 đ',
      //     oldPrice: '1.300.000 đ',
      //     discount: '32% OFF',
      //   },
      ...
      otherProducts: [
        {
          href: "/son-dior-tattoo-addict-lip-tint-backstage-pros-421-natural-tea-mau-cam-dat-ph219140",
          image: require(
            "@/assets/images/productThumnail/son-kem-dior-addict-lip-tattoo-backstage-pros-421-natural-beige-mau-cam-dat-6299bc6d11ac2-03062022144653.jpg"
          ),
          alt: "Son Dior Tattoo Addict Lip Tint Backstage Pros 421 Natural Tea Màu Cam Đất",
          price: "1.140.000 đ",
        },
        {
          href: "/son-kem-dior-addict-lip-maximizer-037-mau-hong-dat-ph219443",
          image: require(
            "@/assets/images/productThumnail/son-kem-dior-addict-lip-maximizer-037-mau-hong-dat-68dce5d8553c1-01102025152704.jpg"
          ),
          alt: "Son Kem Dior Addict Lip Maximizer 037 Màu Hồng Đất",
          price: "860.000 đ",
        },
        {
          href: "/son-dior-rouge-dior-on-stage-lipstick-185-ultimate-pink-mau-hong-nhat-ph219547",
          image: require(
            "@/assets/images/productThumnail/son-dior-rouge-dior-on-stage-lipstick-185-ultimate-pink-mau-hong-nhat-68dde21b9f7cf-02102025092323.jpg"
          ),
          alt: "Son Dior Rouge Dior On Stage Lipstick 185 Ultimate Pink Màu Hồng Nhạt",
          price: "1.750.000 đ",
        },
        {
          href: "/son-kem-li-dior-rouge-forever-liquid-999-forever-dior-mau-do-tuoi-ph220283",
          image: require(
            "@/assets/images/productThumnail/son-kem-dior-rouge-forever-liquid-999-mau-do-tuoi-676e345011e6c-27122024120000.jpg"
          ),
          alt: "Son Kem Lì Dior Rouge Forever Liquid 999 Forever Dior Màu Đỏ Tươi",
          price: "1.450.000 đ",
        },
        {
          href: "/son-kem-dior-rouge-forever-liquid-lacquer-875-enigmatic-mau-do-cherry-ph220650",
          image: require(
            "@/assets/images/productThumnail/son-kem-dior-rouge-forever-liquid-lacquer-875-enigmatic-mau-do-cam-68e61f0580a07-08102025152125.png"
          ),
          alt: "Son Kem Dior Rouge Forever Liquid Lacquer 875 Enigmatic Màu Đỏ Cherry",
          price: "890.000 đ",
        },
        {
          href: "/son-dior-addict-lip-tint-mau-541-natural-sienna-do-dat-ph222393",
          image: require(
            "@/assets/images/productThumnail/son-dior-addict-lip-tint-mau-541-natural-sienna-do-dat-68f20cec3e876-17102025163124.jpg"
          ),
          alt: "Son Dior Addict Lip Tint Màu 541 Natural Sienna Đỏ Đất",
          price: "899.000 đ",
        },
      ],
      activeTab: 'details',
  ...
  methods: {
    ...
    getPercent(star) {
      ...
      const total = Object.values(this.starData).reduce((sum, val) => sum + val, 0);
      const count = this.getCount(star);
      return total > 0 ? (count / total) * 100 : 0;
    },
    saveAnswer(index) {
      // Logic để lưu câu trả lời (có thể gửi lên server hoặc cập nhật state)
      this.$emit('update-answer', { index, answer: this.questions[index].answer });
    }
  },
...
.rating-star-list {
  ...
  width: 100px;
  height: 20px;
  background: url('/assets/images/stars.png') 0 calc(-20px * var(--rating-star)) / 100px 100px no-repeat;
}
