  ...
  <div id="main">
    ...
    <main class="my-4 container">
      <div class="row">
        ...
        <div class="slider-right p-3 rounded col-md-4 col-12" style="height: 315px">
    ...
    <VueSlickCarousel v-bind="bannerSecondCarouselSettings" ref="BannerSecondSlick" class="my-4 container">
      <div v-for="(banner, index) in bannerSecond" :key="index" class="px-2">
        <nuxt-link :to="banner.url">
          <img :src="banner?.image" alt="banner-second" class="rounded w-100 img-fluid" />
        </nuxt-link>
      </div>
    </VueSlickCarousel>
    ...
    <div class="py-4 container category-future">
      ...
      <VueSlickCarousel v-bind="categoryFutureCarouselSettings" class="category-slider">
        <div v-for="(item, index) in categoriesFuture" :key="index" v-if="index < 16"
          class="d-flex flex-column align-items-center px-2">
          <nuxt-link :to="item.url" class="w-100 h-100 card">
            <div class="d-flex align-items-center justify-content-center rounded w-100 img-wrapper">
              <img :src="item.image" :alt="item.title" class="p-3 img-fluid"
                style="height: 100px; object-fit: contain" />
            </div>
            <p class="mt-1 text-center">{{ item.title }}</p>
          </nuxt-link>
          <nuxt-link :to="categoriesFuture[index + 16].url" class="w-100 h-100 card">
            <div class="d-flex align-items-center justify-content-center rounded w-100 img-wrapper">
              <img :src="categoriesFuture[index + 16].image" :alt="categoriesFuture[index + 16].title"
                class="p-3 img-fluid" style="height: 100px; object-fit: contain" />
            </div>
            <p class="mt-1 text-center">{{ categoriesFuture[index + 16].title }}</p>
          </nuxt-link>
        </div>
      </VueSlickCarousel>
    </div>
    ...
    <div class="py-4 container brand-future">
      ...
      <VueSlickCarousel v-bind="brandFutureCarouselSettings" class="brand-slider">
        <div v-for="(item, index) in brandsFuture" :key="index" class="d-flex flex-column align-items-center px-2">
          <nuxt-link :to="item.url" class="w-100 h-100 card">
            <div class="d-flex align-items-center justify-content-center p-2 rounded w-100 img-wrapper">
              <img :src="item.image" :alt="item.title" class="p-3 img-fluid" />
            </div>
          </nuxt-link>
        </div>
    ...
    <div class="my-4 py-4 container trending-search">
      ...
      <div class="row row-cols-1 row-cols-md-5 g-4">
        <nuxt-link :to="item?.url" v-for="(item, index) in trendingSearch" :key="index">
    ...
    <div class="py-4 container perfume-products">
      <h3 class="m-auto mb-3 pb-2 border-3 border-black border-bottom text-center fw-normal" style="width: max-content">
        Nước hoa
      </h3>
      <div class="d-flex flex-wrap justify-content-center product-list row row-cols-1 row-cols-md-5 g-4">
        <div v-for="(product, index) in productPerfume" :key="index" class="px-2">
          <nuxt-link :to="product.url" class="position-relative border-0 h-100 card product-card">
            <!-- Huy hiệu giảm giá -->
            <div class="top-0 position-absolute bg-danger m-2 px-2 py-1 text-white end-0 fs-8" v-if="product.discount">
              {{ product.discount }}% OFF
            </div>
    ...
    <div class="py-4 container cosmetic-products">
      ...
      <div class="d-flex flex-wrap justify-content-center product-list row row-cols-1 row-cols-md-5 g-4">
        <div v-for="(product, index) in productCosmetic" :key="index" class="px-2">
          <nuxt-link :to="product.url" class="position-relative border-0 h-100 card product-card">
            <!-- Huy hiệu giảm giá -->
            <div class="top-0 position-absolute bg-danger m-2 px-2 py-1 text-white end-0 fs-8" v-if="product.discount">
              {{ product.discount }}% OFF
    ...
    <div class="py-4 container handbag-products">
      ...
      <div class="d-flex flex-wrap justify-content-center product-list row row-cols-1 row-cols-md-5 g-4">
        <div v-for="(product, index) in productHandbag" :key="index" class="px-2">
          <nuxt-link :to="product.url" class="position-relative border-0 h-100 card product-card">
            <!-- Huy hiệu giảm giá -->
            <div class="top-0 position-absolute bg-danger m-2 px-2 py-1 text-white end-0 fs-8" v-if="product.discount">
              {{ product.discount }}% OFF
    ...
    <div class="py-4 container fashion-products">
      ...
      <div class="d-flex flex-wrap justify-content-center product-list row row-cols-1 row-cols-md-5 g-4">
        <div v-for="(product, index) in productFashion" :key="index" class="px-2">
          <nuxt-link :to="product.url" class="position-relative border-0 h-100 card product-card">
            <!-- Huy hiệu giảm giá -->
            <div class="top-0 position-absolute bg-danger m-2 px-2 py-1 text-white end-0 fs-8" v-if="product.discount">
              {{ product.discount }}% OFF
    ...
    <div class="py-4 container eyewear-products">
      ...
      <div class="d-flex flex-wrap justify-content-center product-list row row-cols-1 row-cols-md-5 g-4">
        <div v-for="(product, index) in productEyeWear" :key="index" class="px-2">
          <nuxt-link :to="product.url" class="position-relative border-0 h-100 card product-card">
            <!-- Huy hiệu giảm giá -->
            <div class="top-0 position-absolute bg-danger m-2 px-2 py-1 text-white end-0 fs-8" v-if="product.discount">
              {{ product.discount }}% OFF
    ...
    <div class="py-4 container lipstick-products">
      ...
      <div class="d-flex flex-wrap justify-content-center product-list row row-cols-1 row-cols-md-5 g-4">
        <div v-for="(product, index) in productLipStick" :key="index" class="px-2">
          <nuxt-link :to="product.url" class="position-relative border-0 h-100 card product-card">
            <!-- Huy hiệu giảm giá -->
            <div class="top-0 position-absolute bg-danger m-2 px-2 py-1 text-white end-0 fs-8" v-if="product.discount">
              {{ product.discount }}% OFF
    ...
    <div class="py-4 container pickleball-products">
      ...
      <div class="d-flex flex-wrap justify-content-center product-list row row-cols-1 row-cols-md-5 g-4">
        <div v-for="(product, index) in productPickleBall" :key="index" class="px-2">
          <nuxt-link :to="product.url" class="position-relative border-0 h-100 card product-card">
            <!-- Huy hiệu giảm giá -->
            <div class="top-0 position-absolute bg-danger m-2 px-2 py-1 text-white end-0 fs-8" v-if="product.discount">
              {{ product.discount }}% OFF
    ...
    <div class="py-4 container perfume-products">
      ...
      <div class="d-flex flex-wrap justify-content-center product-list row row-cols-1 row-cols-md-4 g-4">
        <div v-for="(item, index) in blog" :key="index" class="px-2">
          <nuxt-link :to="item.url" class="position-relative border-0 h-100 card item-card">
            <!-- Ảnh sản phẩm -->
      ...
      <main class="my-8 container">
        ...
        <section class="mb-6">
          ...
          <p class="text-gray-600 leading-relaxed">
            ...
            khuyến mãi, các
            <a href="#" class="text-blue-500 hover:underline">mã voucher giảm giá</a>
          ...
          <p class="text-gray-600 leading-relaxed">
            ...
            <a href="#" class="text-blue-500 hover:underline">Order Hàng Quốc Tế</a>
          ...
          <p class="text-gray-600 leading-relaxed">
            ...
            <a href="#" class="text-blue-500 hover:underline">Blog Vua Hàng Hiệu</a>
        ...
        <div id="collapseDescription" class="collapse" :class="{ show: isExpanded }">
          <section class="mb-6">
            <h4 class="mb-4 font-bold text-gray-800 text-2xl">
            ...
            <p class="text-gray-600 leading-relaxed">
              ...
              cần
              <a href="#" class="text-blue-500 hover:underline">tải ứng dụng Vua Hàng Hiệu</a>
          ...
          <section class="mb-6">
            ...
            <p class="text-gray-600 leading-relaxed">
              ...
              <a href="#" class="text-blue-500 hover:underline">chương trình Flash Sale</a>
              lớn hằng năm như các ngày lễ tết: Tết Dương Lịch 1/1, Tết Nguyên
              Đán, Valentine 14/2, Quốc tế Phụ nữ 8/3, Ngày của Mẹ, Ngày của
              Cha,
              <a href="#" class="text-blue-500 hover:underline">Phụ Nữ Việt Nam 20-10</a>, Ngày Nhà Giáo 20/11, Giáng
              Sinh…
            </p>
            <p class="text-gray-600 leading-relaxed">
          ...
          <section class="mb-6">
            ...
            <p class="text-gray-600 leading-relaxed">
              ...
              <a href="#" class="text-blue-500 hover:underline">thời trang cao cấp</a>
              ...
              <a href="#" class="text-blue-500 hover:underline">Dolce Gabbana</a>, <a href="#"
                class="text-blue-500 hover:underline">Burberry</a>,
              ...
              <a href="#" class="text-blue-500 hover:underline">Paula’s Choice</a>,
              <a href="#" class="text-blue-500 hover:underline">Estée Lauder</a>, <a href="#"
                class="text-blue-500 hover:underline">Kiehl's</a>,
            ...
            <p class="text-gray-600 leading-relaxed">
              ...
              <a href="#" class="text-blue-500 hover:underline">nước hoa sang trọng</a>
              được yêu thích như
            ...
            <p class="text-gray-600 leading-relaxed">
              Hay các hãng
              <a href="#" class="text-blue-500 hover:underline">giày hàng hiệu</a>
              phổ biến hiện nay như: MLB, Adidas, Nike, Converse, New Balance,
              Vans,... Hay những mẫu
              <a href="#" class="text-blue-500 hover:underline">túi xách đắt tiền</a>
            ...
            <p class="text-gray-600 leading-relaxed">
              ...
              chọn ngay những món
              <a href="#" class="text-blue-500 hover:underline">đồ hiệu cũ chính hãng</a>. Đây là các sản phẩm đã qua sử
              dụng nhưng được chúng tôi cam kết
          ...
          <section class="mb-6">
            ...
            <p class="text-gray-600 leading-relaxed">
              ...
              <a href="#" class="text-blue-500 hover:underline">thời trang nam</a>,
              <a href="#" class="text-blue-500 hover:underline">thời trang nữ</a>, <a href="#"
                class="text-blue-500 hover:underline">đồng hồ</a>,
              túi xách, giày dép,
            ...
            <p class="text-gray-600 leading-relaxed">
              ...
              được
              <a href="#" class="text-blue-500 hover:underline">mã giảm giá đến 50%</a>, đổi điểm khi mua hàng và còn
              rất nhiều quà tặng thú vị khác
              nữa.
            </p>
            <p class="text-gray-600 leading-relaxed">
              Hãy truy cập ngay
              <a href="https://vuahanghieu.com" target="_blank"
                class="text-blue-500 hover:underline">Vuahanghieu.com</a>
              hoặc tải ngay
              <a href="#" class="text-blue-500 hover:underline">ứng dụng Vua Hàng Hiệu</a>
...
export default {
  ...
  data() {
    return {
      ...
      // Category Future
      categoriesFuture: [
        { id: 1, title: "Nước hoa", url: "#", image: require("@/assets/images/category/1614234988_Nuoc_hoa_Perfume.webp") },
        { id: 2, title: "Nước hoa Nam", url: "#", image: require("@/assets/images/category/1752560727_nuoc-hoa-nam.webp") },
        { id: 3, title: "Nước hoa Nữ", url: "#", image: require("@/assets/images/category/1752560745_nuoc-hoa-nu.webp") },
        { id: 4, title: "Đồng hồ", url: "#", image: require("@/assets/images/category/1614234709_dong-do-chinh-hang.webp") },
        { id: 5, title: "Mũ nón", url: "#", image: require("@/assets/images/category/1614235850_mu_non_caps.webp") },
        { id: 6, title: "Mỹ phẩm", url: "#", image: require("@/assets/images/category/1614236856_my_pham-Cosmetics.webp") },
        { id: 7, title: "Kem chống nắng", url: "#", image: require("@/assets/images/category/1642492758_kem-chong-nang.webp") },
        { id: 8, title: "Giày nam", url: "#", image: require("@/assets/images/category/1642494665_shoes.webp") },
        { id: 9, title: "Son môi", url: "#", image: require("@/assets/images/category/1642492020_lipstick.webp") },
        { id: 10, title: "Loa Bluetooth", url: "#", image: require("@/assets/images/category/1744624289_loa-bluetooth.webp") },
        { id: 11, title: "Tai nghe", url: "#", image: require("@/assets/images/category/1744685875_tai-nghe-bluetooth.webp") },
        { id: 12, title: "Túi xách", url: "#", image: require("@/assets/images/category/1642491921_bag.webp") },
        { id: 13, title: "Kính mắt", url: "#", image: require("@/assets/images/category/1614235638_kinh_mat_sunglasses.webp") },
        { id: 14, title: "Giày nữ", url: "#", image: require("@/assets/images/category/1643083743_giay-nu.webp") },
        { id: 15, title: "Thời trang", url: "#", image: require("@/assets/images/category/1642491919_fashion.webp") },
        { id: 16, title: "Trang sức", url: "#", image: require("@/assets/images/category/1642491760_icon_trang-suc-11012022145839[1].webp") },
        { id: 17, title: "Đồ chơi mô hình", url: "#", image: require("@/assets/images/category/1657768241_dochoimohinh.webp") },
        { id: 18, title: "Máy rửa mặt", url: "#", image: require("@/assets/images/category/1642492212_may-rua-mat.webp") },
        { id: 19, title: "Máy Massage", url: "#", image: require("@/assets/images/category/1642492397_may-massage.webp") },
        { id: 20, title: "Lăn khử mùi", url: "#", image: require("@/assets/images/category/1642492469_lan-khu-mui.webp") },
        { id: 21, title: "Sữa rửa mặt", url: "#", image: require("@/assets/images/category/1642492618_sua-rua-mat.webp") },
        { id: 22, title: "Trang điểm", url: "#", image: require("@/assets/images/category/1634096891_trang-diem-vuahanghieu.webp") },
        { id: 23, title: "Dép Hiệu", url: "#", image: require("@/assets/images/category/1642495869_dep.webp") },
        { id: 24, title: "Chăm sóc tóc", url: "#", image: require("@/assets/images/category/1634096911_cham-soc-toc-vuahanghieu.webp") },
        { id: 25, title: "Công nghệ", url: "#", image: require("@/assets/images/category/1667617963_phu-kien-cong-nghe.webp") },
        { id: 26, title: "Máy triệt lông", url: "#", image: require("@/assets/images/category/1642493924_may-triet-long.webp") },
        { id: 27, title: "Phụ kiện", url: "#", image: require("@/assets/images/category/1657768681_phukienthoitrang.webp") },
        { id: 28, title: "Máy trị mụn", url: "#", image: require("@/assets/images/category/1642492897_may-tri-mun.webp") },
        { id: 29, title: "Máy phun sương", url: "#", image: require("@/assets/images/category/1645780422_may-phun-suong.webp") },
        { id: 30, title: "Móc khóa", url: "#", image: require("@/assets/images/category/1739774892_moc-khoa-hang-hieu.webp") },
        { id: 31, title: "Nến thơm", url: "#", image: require("@/assets/images/category/1739775239_nen-thom-hang-hieu.webp") },
        { id: 32, title: "Thắt lưng", url: "#", image: require("@/assets/images/category/1739775466_that-lung-cao-cap.webp") },
      ],
