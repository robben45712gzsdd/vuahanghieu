<template>
    <div>
        ...
        <!-- Modal đăng nhập -->
        <a-modal v-model="visible" :footer="null" :closable="true" width="440px" centered>
            <div class="login-modal">
                ...
                <div class="login-options">
                    ...
                    <div class="login-btn" @click="handlePhoneLogin">
                        <div class="icon-wrapper">
                            <svg fill="currentColor" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width="1em"
                                height="1em">
                                <path
                                    d="M24 3a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm0 23C13.06 26 7 33.92 7 40.44 7 44 9 44 16 44h16c7 0 9 0 9-3.56C41 33.92 34.94 26 24 26Z">
                                </path>
                            </svg>
                        </div>
                        <span>Số dùng số điện thoại/email/tên người dùng</span>
                    </div>

                    <div class="login-btn" @click="handleFacebookLogin">
                        <div class="icon-wrapper">
                            <!-- Icon Facebook - bạn thêm icon sau -->
                            <svg width="1em" data-e2e="" height="1em" viewBox="0 0 48 48" fill="none"
                    ...
                    <div class="login-btn" @click="handleGoogleLogin">
                        <div class="icon-wrapper">
                            <!-- Icon Google - bạn thêm icon sau -->
                            <svg width="1em" data-e2e="" height="1em" viewBox="0 0 48 48" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="login-btn" @click="handleLineLogin">
                        <div class="icon-wrapper">
                            <!-- Icon LINE - bạn thêm icon sau -->
                            <svg width="1em" data-e2e="" height="1em" viewBox="0 0 48 48" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <div class="login-btn" @click="handleKakaoLogin">
                        <div class="icon-wrapper">
                            <!-- Icon KakaoTalk - bạn thêm icon sau -->
                            <svg width="1em" data-e2e="" height="1em" viewBox="0 0 48 48" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M24 47.001C36.7026 47.001 47 36.7035 47 24.001C47 11.2984 36.7026 1.00098 24 1.00098C11.2975 1.00098 1 11.2984 1 24.001C1 36.7035 11.2975 47.001 24 47.001Z"
                    ...
                    <div class="login-btn" @click="handleAppleLogin">
                        <div class="icon-wrapper">
                            <!-- Icon Apple - bạn thêm icon sau -->
                            <svg width="1em" data-e2e="" height="1em" viewBox="0 0 48 48" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="footer-text">
                    Bằng việc tiếp tục với tài khoản có vị trí tại <strong>Campuchia</strong>, bạn
                    đồng ý với <a href="#" @click.prevent="handleTerms">Điều khoản dịch vụ</a>, đồng thời xác nhận rằng
                    bạn
                    đã đọc <a href="#" @click.prevent="handlePrivacy">Chính sách quyền riêng tư</a> của chúng tôi.
                </div>
            </div>
        </a-modal>
    </div>
...
export default {
    ...
    methods: {
        ...
        handleQRLogin() {
            // Logic đăng nhập bằng QR - bạn thêm sau
            console.log('Đăng nhập bằng QR');
            // this.visible = false
        },
        handlePhoneLogin() {
            // Logic đăng nhập bằng phone/email - bạn thêm sau
            console.log('Đăng nhập bằng phone/email');
            // this.visible = false
        },
        handleFacebookLogin() {
            // Logic đăng nhập bằng Facebook - bạn thêm sau
            console.log('Đăng nhập bằng Facebook');
            // this.visible = false
        },
        handleGoogleLogin() {
            // Logic đăng nhập bằng Google - bạn thêm sau
            console.log('Đăng nhập bằng Google');
            // this.visible = false
        },
        handleLineLogin() {
            // Logic đăng nhập bằng LINE - bạn thêm sau
            console.log('Đăng nhập bằng LINE');
            // this.visible = false
        },
        handleKakaoLogin() {
            // Logic đăng nhập bằng KakaoTalk - bạn thêm sau
            console.log('Đăng nhập bằng KakaoTalk');
            // this.visible = false
        },
        handleAppleLogin() {
            // Logic đăng nhập bằng Apple - bạn thêm sau
            console.log('Đăng nhập bằng Apple');
            // this.visible = false
        },
        handleTerms() {
            // Logic xem điều khoản - bạn thêm sau
            console.log('Xem điều khoản dịch vụ');
        },
        handlePrivacy() {
            // Logic xem chính sách - bạn thêm sau
            console.log('Xem chính sách quyền riêng tư');
        },
    },
};
</script>
